namespace Learnera.Migrations
{
    ...
    public partial class first : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        Text = c.String(),
                        Author_Id = c.String(maxLength: 128),
                        CommentReplies_CommentId = c.Int(),
                        ApplicationUser_Id = c.String(maxLength: 128),
                        ApplicationUser_Id1 = c.String(maxLength: 128),
                    })
                .PrimaryKey(t => t.ReplyId)
                .ForeignKey("dbo.AspNetUsers", t => t.Author_Id)
                .ForeignKey("dbo.Comments", t => t.CommentReplies_CommentId)
                .ForeignKey("dbo.AspNetUsers", t => t.ApplicationUser_Id)
                .ForeignKey("dbo.AspNetUsers", t => t.ApplicationUser_Id1)
                .Index(t => t.Author_Id)
                .Index(t => t.CommentReplies_CommentId)
                .Index(t => t.ApplicationUser_Id)
                .Index(t => t.ApplicationUser_Id1);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Replies", "ApplicationUser_Id1", "dbo.AspNetUsers");
            ...
            DropForeignKey("dbo.AspNetUsers", "Reply_ReplyId", "dbo.Replies");
            DropForeignKey("dbo.Replies", "CommentReplies_CommentId", "dbo.Comments");
            ...
            DropIndex("dbo.Replies", new[] { "ApplicationUser_Id1" });
            DropIndex("dbo.Replies", new[] { "ApplicationUser_Id" });
            DropIndex("dbo.Replies", new[] { "CommentReplies_CommentId" });
            DropIndex("dbo.Replies", new[] { "Author_Id" });
            DropIndex("dbo.AspNetUserClaims", new[] { "UserId" });
            DropIndex("dbo.AspNetUsers", new[] { "Comment_CommentId" });
            DropIndex("dbo.AspNetUsers", new[] { "Reply_ReplyId" });
